...
### Document 1: `HelmRelease` `tdarr-node`
...
| `metadata.name` | `tdarr-node` | Keeps object identity stable so upgrades and references continue to work predictably. |
...
### Document 1: `HorizontalPodAutoscaler` `tdarr-node`
...
| `spec.scaleTargetRef.name` | `tdarr-node` | Set intentionally to match this repository's desired-state for this component. |
...
| `spec.behavior.scaleDown.stabilizationWindowSeconds` | `300` | Numeric value tuned for current workload size, reliability, and cluster capacity. |
| `spec.behavior.scaleDown.policies` | `list[1]` | Set intentionally to match this repository's desired-state for this component. |
| `spec.behavior.scaleDown.policies.[0].type` | `Percent` | Set intentionally to match this repository's desired-state for this component. |
| `spec.behavior.scaleDown.policies.[0].value` | `50` | Numeric value tuned for current workload size, reliability, and cluster capacity. |
...
| `spec.behavior.scaleUp.policies` | `list[2]` | Set intentionally to match this repository's desired-state for this component. |
| `spec.behavior.scaleUp.policies.[0].type` | `Percent` | Set intentionally to match this repository's desired-state for this component. |
| `spec.behavior.scaleUp.policies.[0].value` | `100` | Numeric value tuned for current workload size, reliability, and cluster capacity. |
| `spec.behavior.scaleUp.policies.[0].periodSeconds` | `60` | Numeric value tuned for current workload size, reliability, and cluster capacity. |
