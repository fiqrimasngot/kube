...
| `metadata.name` | `i2pd` | Keeps object identity stable so upgrades and references continue to work predictably. |
...
| `configMapGenerator.[0].name` | `i2pd` | Set intentionally to match this repository's desired-state for this component. |
